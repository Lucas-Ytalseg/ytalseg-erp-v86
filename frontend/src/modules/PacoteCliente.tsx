...
export default function PacoteCliente() {
  ...
  function enviarPacoteAgora(p: Pacote) {
    const payload = {
      ...
      criadoEm: p.criadoEm,
      mensagem: [
        `Olá, segue o pacote do cliente ${p.cliente || ""} para conferência.`,
        "",
        `Valor: ${brl(p.valor)}`,
        `Status: ${p.status}`,
        "",
    ...
    localStorage.setItem("ytalseg_envio_pdf_handoff_v14", JSON.stringify(payload));
    setExportStatus("Pacote enviado para a tela Envio PDF. Abra o menu Envio PDF para continuar.");
  }
          ...
          <div className="pacote-item" key={p.id}>
            <div className="pacote-item-top">
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                ...
                <button className="pacote-btn pacote-btn-green" onClick={() => enviarPacoteAgora(p)}>Enviar agora</button>
