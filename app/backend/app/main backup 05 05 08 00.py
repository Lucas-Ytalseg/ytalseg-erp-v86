...
def escanear_pdf_padrao_por_template(file_path: Path):
    ...
    # Depois vamos detectar mês/ano; para o arquivo atual é Março/2026.
    mes = 3
    ano = 2026
    ...
    for dia in range(1, 32):
        ...
        adicional_noturno = EMPRESA_ATUAL["adicional_noturno"] if noturno and EMPRESA_ATUAL["usa_adicional_noturno"] else 0
...
async def upload_pdf(
    ...
    try:
        ...
        calculo = escanear_pdf_padrao_por_template(file_path)
