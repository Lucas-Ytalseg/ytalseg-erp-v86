    ...
    try {
      ...
      const diasApi = (data.calculo?.dias_detectados || []).map((d: any) => {
        ...
        if (partes.length === 3) {
          ...
          return { ...d, data: `${dia}/${String(mesAnalise).padStart(2, "0")}/${anoAnalise}`, semana: semanaCorrigida, tipo_dia: tipoDiaPorSemana(semanaCorrigida) };
        }
        return d;
      });
...
.rep-line{
  ...
  font-weight:700;
        ...
        /* V63 CABECALHO VALORES */
        .info .value { font-size: 20px !important; font-weight: 1000 !important; line-height: 1.22 !important; }
        .preview-mode .info .value { font-size: 11.8px !important; font-weight: 1000 !important; line-height: 1.18 !important; }
        .info .label { font-size: 13px !important; font-weight: 1000 !important; }
        .preview-mode .info .label { font-size: 8px !important; font-weight: 1000 !important; }
